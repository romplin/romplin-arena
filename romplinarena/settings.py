"""
Django settings for romplinarena project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'romplinarena', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'romplinarena.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'romplin-arena/static/'),
]
